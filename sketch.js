...
mainCyclist.velocityX=4
  
//set collider for mainCyclist

  
gameOver = createSprite(mainCyclist.x+300,150);
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Distance: "+ distance,mainCyclist.x,30);
  ...
  if(path.x < mainCyclist.x ){
    path.x = mainCyclist.x+300;
  }
...
function pinkCyclists(){
        player1 =createSprite(mainCyclist.x+500,Math.round(random(50, 250)));
        player1.scale =0.06;
        player1.velocityX = -1
